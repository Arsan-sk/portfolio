...
import { User, Code, Palette, Cpu, BrainCircuit, Filter } from "lucide-react";
            ...
            <div className="relative bg-gray-800 rounded-lg p-8 border border-gray-700">
              ...
              <div className="space-y-6">
                <div className="relative pl-8 border-l-2 border-purple-500/30">
                  ...
                  <h4 className="text-lg font-semibold text-purple-400">Education</h4>
                  <p className="text-gray-300 mt-2">B.Tech in Computer Science</p>
                ...
                <div className="relative pl-8 border-l-2 border-blue-500/30">
                  ...
                  <h4 className="text-lg font-semibold text-blue-400">Frontend Development</h4>
                  <p className="text-gray-300 mt-2">Building responsive web applications with modern frameworks</p>
                ...
                <div className="relative pl-8 border-l-2 border-pink-500/30">
                  ...
                  <h4 className="text-lg font-semibold text-pink-400">AI Explorations</h4>
                  <p className="text-gray-300 mt-2">Diving into AI/ML technologies and applications</p>
            ...
            {filteredSkills.map((skill, index) => (
              ...
              >
                <div className="relative preserve-3d w-full h-full duration-700 group-hover:rotate-y-180">
                  {/* Front of card */}
                  <div className="skill-card-front absolute inset-0 bg-gray-800 rounded-xl p-6 border border-gray-700 flex flex-col items-center justify-center backface-hidden">
                  ...
                  {/* Back of card */}
                  <div className="skill-card-back absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700 flex flex-col justify-between backface-hidden rotate-y-180">
                    <div>
                    ...
                    <div>
                      <span className="text-xs text-gray-400 inline-block bg-gray-700 px-2 py-1 rounded">{skill.category}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-24 relative">
          ...
          <div className="flex justify-between absolute -top-4 right-0 space-x-2 z-10">
            <button 
              ...
              className={`p-2 rounded-full ${servicesPage === 0 ? 'bg-gray-700 text-gray-500' : 'bg-purple-500 text-white'}`}
            >
              ← Prev
            </button>
            <button 
              ...
              className={`p-2 rounded-full ${servicesPage >= Math.ceil(services.length / 3) - 1 ? 'bg-gray-700 text-gray-500' : 'bg-purple-500 text-white'}`}
            >
              Next →
            </button>
          </div>
          ...
          >
            <div className="w-[300%] md:w-[200%] lg:w-full flex transition-transform duration-500">
              {services.map((service, index) => (
                ...
                >
                  <div className="bg-gray-800 p-8 rounded-lg hover:shadow-xl transition-all duration-500 border border-gray-700 group h-full">
            ...
            {Array.from({ length: Math.ceil(services.length / 3) }, (_, i) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  i === servicesPage ? 'bg-purple-500 w-6' : 'bg-gray-600'
                }`}
              />
            ))}
          </div>
