    ...
    >
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between z-10">
        <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
          ...
          <p className={`max-w-2xl mx-auto lg:mx-0 mb-10 text-lg animate-fadeInUp animation-delay-600 ${
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fadeInUp animation-delay-900">
            ...
            <a 
              href="#contact"
              className={`px-8 py-3 border-2 border-purple-500 font-medium rounded-full hover:bg-purple-500/20 transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden group ${
                theme === 'dark' ? 'text-white' : 'text-gray-800'
              }`}
            >
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end">
          ...
          >
            ...
            <div className={`absolute inset-3 w-[calc(100%-24px)] h-[calc(100%-24px)] rounded-full z-5 ${
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce sm:hidden">
        <button onClick={scrollToAbout} className={`p-2 rounded-full hover:bg-opacity-30 transition-all ${
          theme === 'dark' ? 'bg-white/10 hover:bg-white/20 text-white' : 'bg-purple-500/20 hover:bg-purple-500/40 text-purple-700'
        }`}>
