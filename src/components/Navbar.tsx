    ...
    <>
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <a
            href="#"
            className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent relative"
          >
            Portfolio
          </a>
      ...
      {/* Mobile Menu Overlay - rendered outside the nav so it always covers the page */}
      <div
        className={`fixed inset-0 z-50 bg-opacity-95 backdrop-blur-sm transition-all duration-300 md:hidden flex flex-col justify-center items-center ${isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
          } ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'}`}
        aria-hidden={!isOpen}
      >
        {/* Overlay Header: title, theme toggle, close button */}
